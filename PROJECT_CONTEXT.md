...
- Horrorfest overlay:
  ...
  - Horrorfest analytics now also includes repeat-pattern curation reports for staples, streaks, gaps, and dormant titles under `/api/v1/horrorfest/analytics/curation/*`
